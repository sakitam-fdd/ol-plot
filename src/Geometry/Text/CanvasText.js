...
const CanvasText = function (o) {
  ...
  self._hiddenInput.addEventListener('keydown', function (e) {
    ...
    if (self._hasFocus) {
      // hack to fix touch events bug in iOS Safari
      window.focus()
      self._hiddenInput.focus()

      // continue with the keydown events
      self.keydown(e, self)
    }
  })
...
CanvasText.prototype = {
   ...
   * @return {Mixed}      CanvasText or current canvas.
   */
   ...
   * @return {Mixed}      CanvasText or current x-value.
   */
  x: function (data) {
    var self = this
   ...
   * @return {Mixed}      CanvasText or current y-value.
   */
  y: function (data) {
    var self = this
   ...
   * @return {Mixed}      CanvasText or current font size.
   */
   ...
   * @return {Mixed}      CanvasText or current font family.
   */
   ...
   * @return {Mixed}      CanvasText or current font color.
   */
   ...
   * @param  {String} data Font color.
   * @return {Mixed}      CanvasText or current place holder font color.
   */
   ...
   * @return {Mixed}      CanvasText or current font weight.
   */
   ...
   * @return {Mixed}      CanvasText or current font style.
   */
   ...
   * @return {Mixed}      CanvasText or current font shadow color.
   */
   ...
   * @return {Mixed}      CanvasText or current font shadow blur.
   */
   ...
   * @return {Mixed}      CanvasText or current font shadow x-offset.
   */
   ...
   * @return {Mixed}      CanvasText or current font shadow y-offset.
   */
   ...
   * @return {Mixed}      CanvasText or current width.
   */
  width: function (data) {
    var self = this
   ...
   * @return {Mixed}      CanvasText or current height.
   */
   ...
   * @return {Mixed}      CanvasText or current padding.
   */
   ...
   * @return {Mixed}      CanvasText or current border width.
   */
   ...
   * @return {Mixed}      CanvasText or current border color.
   */
   ...
   * @return {Mixed}      CanvasText or current border radius.
   */
   ...
   * @return {Mixed}      CanvasText or current background color.
   */
   ...
   * @return {Mixed}      CanvasText or current background gradient.
   */
   ...
   * @return {Mixed}          CanvasText or current box shadow.
   */
   ...
   * @return {Mixed}          CanvasText or current inner shadow.
   */
   ...
   * @return {Mixed}      CanvasText or current selection color.
   */
   ...
   * @return {Mixed}      CanvasText or current place holder text.
   */
   ...
   * @return {Mixed}      CanvasText or current text value.
   */
  value: function (data) {
    var self = this
  ...
  /**
   * Set or fire the onsubmit events.
  ...
  /**
   * Set or fire the onkeydown events.
   * @param  {Function} fn Custom callback.
   */
  ...
  /**
   * Set or fire the onkeyup events.
   * @param  {Function} fn Custom callback.
   */
  onkeyup: function (fn) {
    var self = this
  ...
  /**
   * Place focus on the CanvasText box, placing the cursor
  ...
  focus: function (pos) {
    ...
    // only fire the focus events when going from unfocussed
    if (!self._hasFocus) {
      self._onfocus(self)
  ...
  /**
   * Removes focus from the CanvasText box.
  ...
  /**
   * Fired with the keydown events to draw the typed characters.
   * @param  {Event}       e    The keydown events.
   * @param  {CanvasText} self
   * @return {CanvasText}
   */
  ...
  /**
   * Fired with the click events on the canvas, and puts focus on/off
  ...
  /**
   * Fired with the mousemove events to update the default cursor.
   * @param  {Event}       e    The mousemove events.
   * @param  {CanvasText} self
   * @return {CanvasText}
   */
  ...
  /**
   * Fired with the mousedown events to start a selection drag.
   * @param  {Event} e    The mousedown events.
   * @param  {CanvasText} self
   */
  ...
  /**
   * Fired with the mouseup events to end a selection drag.
   * @param  {Event} e    The mouseup events.
   * @param  {CanvasText} self
   */
  ...
  /**
   * Clears and redraws the CanvasText on an off-DOM canvas,
  ...
  render: function () {
    ...
    self._drawTextBox(function () {
      ...
      var textY = Math.round(paddingBorder + self._height / 2)
      ...
      var isColor = self._innerShadow === 'none' ? '' : innerShadow[3]
  ...
  _updateCanvasWH: function () {
    ...
    var oldH = self._renderCanvas.height
  ...
  _overInput: function (x, y) {
    var self = this
    var xLeft = x >= self._x + self._extraX
    var xRight = x <= self._x + self._extraX + self._width + self._padding * 2
    var yTop = y >= self._y + self._extraY
    var yBottom = y <= self._y + self._extraY + self._height + self._padding * 2
  ...
  /**
   * Calculate the mouse position based on the events callback and the elements on the page.
   * @param  {Event} e
