 ...
 * @private
 */
$Factory.prototype._getRegularShape = function (options) {
  try {
 ...
 * @private
 */
$Factory.prototype._getImage = function (options) {
  try {
    let image
    options = options || {}
 ...
 * @private
 */
$Factory.prototype._getIcon = function (options) {
  try {
    options = options || {}
    let icon = new $Icon({
 ...
 * @private
 */
$Factory.prototype._getStroke = function (options) {
  try {
    options = options || {}
 ...
 * @private
 */
$Factory.prototype._getText = function (options) {
  try {
    let text = new $Text({
 ...
 * @private
 */
$Factory.prototype._getFill = function (options) {
  try {
    options = options || {}
    let fill = new $Fill({
